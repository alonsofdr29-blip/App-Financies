...
export default function ChartCard({
  ...
  return (
    <SmallCard className="p-4">
      <div className="rounded-3xl bg-slate-50/90 ring-1 ring-slate-200 dark:bg-slate-900/70 dark:ring-slate-700 p-4">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {chartData.map((x) => (
            <span
              key={x.name}
              className="inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-xs font-semibold ring-1 ring-slate-200 dark:bg-slate-900/80 dark:ring-slate-700"
            >
